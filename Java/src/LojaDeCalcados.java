        ...
        preco.add(35.50);*/
            ...
            switch (menu) {
                case "1": cadastrarProduto(scan);
                    break;
                case "2": listarProduto("", 2);
                    break;
                case "3": listarProduto("", 3);
                    break;
                case "4": listarProduto(", para calcular o preço medio", 4);
                    break;
                case "5": listarProduto(", para calcular produtos com preço acima da media", 5);
                    break;
                case "6": listarProduto(", para calcular preço total dos produtos", 6);
                    break;
                case "7": atualizarRemoverProduto(scan);
                    break;
                default:
